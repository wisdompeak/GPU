...
#include "kernel_IterativeRecon_universal_multiGPU.cu"  // Always be inlcuded together

// #include "host_IterativeRecon_CBCT.c"  // pick either single version or multi version
