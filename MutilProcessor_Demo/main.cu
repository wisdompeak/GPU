...
/***    AddProjection(d_proj_addr);  ***/
   ...
   // method 1 (Best performance) 771ms
...
//     for (int i=1; i<Max_num_device; i++)
//     {        
//         kernel_add<<<dimgrid, dimblock>>>(d_proj_addr[0],h_proj+Num_elem/Max_num_device*i);            
//         cudaDeviceSynchronize();
//     }                      
//     cudaMemcpyAsync(h_proj,d_proj_addr[0],single_gpu_chunk_size,cudaMemcpyDefault);
//     cudaDeviceSynchronize();    
//     for (int i=0; i<Max_num_device; i++)
//     {        
//         cudaSetDevice(i); 
