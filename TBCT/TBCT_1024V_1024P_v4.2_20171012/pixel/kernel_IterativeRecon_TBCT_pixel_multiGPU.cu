...
__global__ void backprj_ray_driven_3d_kernel_multiGPU(float *d_f_weightedLenSum , float *d_f_LenSum , float *d_proj_correction, float sin_theta, float cos_theta, int subVolIdx)
{
