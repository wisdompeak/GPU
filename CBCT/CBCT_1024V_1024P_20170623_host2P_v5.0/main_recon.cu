...
#define Number_of_Devices 4  // if it is an odd, please modify your volume and projection size
#define CT_style 0          // 0: CBCT;   1: multi-layer FBCT;  2: multi-layer parallel beam

#define DEBUG 1
#define CT_TOMO 0           // 0: CT;  1: tomosynthesis
 ...
 main(int argc, char ** argv)
{
    ...
    char directory[]="/home/huifeng/DualEnergy/Simulation_Breast/ScoutReconstruction_tomography/";
    char objectName[]="SLPhantom";
	...
	bzero(h_proj_forward, size_proj_data);            
...
//  		sprintf(filename,"/home/huifeng/DualEnergy/Simulation_Breast/ProjectionGeneration_tomography/projection_data/proj_view_2D_%.02f.dat", fileAngle);
// //         strcat(filename,fn);
//         cout<<filename<<endl;
...
//         fread(h_proj_data + j*Z_prj*R, sizeof(float)*Z_prj*R,1,fp);
//         fclose(fp);        
// 	}      
//     
...
//         }
        ...
        if (FISTA==1)
        {
            ...
            cudaMemcpy(F_recon, F_Y_k, size_volume, cudaMemcpyDefault);               
            ...
            memcpy(F_X_k_1, F_recon, size_volume);
        	...
        	fclose(fp);      
//             SaveDeviceDataToFile(F_recon, size_volume, filename);
