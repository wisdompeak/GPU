...
void FFT(complex<double> *x,int n,int FLAG=1)
//FLAG=1 Fourier Transform
//FLAG=-1 Inverse Fourier Transform
{
    int i;
    ...
    else
    {
        ...
        fft(n,x1,y1,x2,y2);
        for(i=0;i<n;i++)
            x[i]=complex<double>(x2[i]/n, -y2[i]/n);
    }
